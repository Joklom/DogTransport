...
{
    public partial class FleshedOutUser : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DogTransportUser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DogTransportUser_Rescue_RescueID",
                        column: x => x.RescueID,
                        principalTable: "Rescue",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DogTransportUser_RescueID",
                table: "DogTransportUser",
                column: "RescueID");
        }
